...
// @todo: сделать как-нибудь отличия буквы О от буквы С, и цифра 7 от цифры 2. Можно поправить символы в файле syms
...
// @todo: при поиске региона сделать что бы цифры региона искались и по контурам, а не только по коэффициентам.
